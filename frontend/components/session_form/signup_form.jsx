    ...
    <div className="signup-main-div">
      ...
      <div className='signup-body'>
        <form onSubmit={handleSubmit}>
          <div className='signup-form'>
            ...
            <p>RobinsJacket lets you invest in companies you trust, <br/> commission-free.</p>
      ...
      <div className='signup-footer'>
        ...
        <p>
          ...
          <Link to="/loremips">FINRA</Link>{" "}&amp;{" "}
          <Link to="/loremips">SIPC.</Link>{" "}
          Additional information about your broker can be found by clicking{" "}
          <Link to="/loremips">here</Link>
        ...
        <p>
          ...
          Securities, LLC on{" "}
          <Link to="/loremips">FINRA's BrokerCheck</Link>
          .
        </p>

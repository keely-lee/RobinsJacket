...
one = StocksWatchlist.create!(stock_id: aapl.id, ticker: appl.ticker, watchlist_id: big_five.id)
...
l = Transaction.create!(transaction_date: "2018-06-12", transaction_type: "sale", shares: 10, price: 370.0125, portfolio_id: mixed.id, stock_id: tsla.id)
